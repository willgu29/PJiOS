...
-(void)messagesReceived:(id)messages {
    NSMutableArray *messageArray = [[NSMutableArray alloc] init];
    for (NSDictionary *message in messages) {
        Message *newMessage = [Message new];
        newMessage.username = message[@"fullName"];
        newMessage.text = message[@"text"];
        [messageArray addObject:newMessage];
    }
    
    NSArray *reversed = [[messageArray reverseObjectEnumerator] allObjects];
...
//    [[MessagesManager sharedInstance] connect];
...
{
//    [[TupleActions sharedInstance] getMessages:@"Test"];
//    [APICalls sharedInstance].delegateMessages = self;
...
//    
//    [[MessagesManager sharedInstance] sendMessage:[self.textView.text copy] userID:@"Test" fullName:@"Will Gu" threadID:@"Test"];
//    [[TupleActions sharedInstance] createMessage:[self.textView.text copy]];
